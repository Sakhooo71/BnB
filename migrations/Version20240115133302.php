 ...
 */
final class Version20240115133302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room ALTER cover TYPE VARCHAR(255)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE room ALTER cover TYPE VARCHAR(50)');
    }
}
